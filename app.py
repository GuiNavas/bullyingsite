...
# If this module is imported by a WSGI server (gunicorn), initialize the DB/tables once.
try:
    init_db()
except Exception:
    # In some deployment environments initialization may fail during import time;
    # it'll be attempted again when the server runs the module or first request.
    pass
